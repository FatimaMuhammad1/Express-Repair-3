...
import { a as Route$1, B as Button, C as Card, c as cn } from "./router-BLFYJHA5.mjs";
import { I as Input } from "./input-DjzLYhrE.mjs";
import { T as Textarea } from "./textarea-C6413dK6.mjs";
import { g as getStoredToken, b as buildUrl, a as getAuthHeaders, B as Badge } from "./api-Bxgm8034.mjs";
...
import { C as Clock, u as CircleAlert, aB as ArrowLeft, aE as Printer, aF as Receipt, U as User, P as Phone, v as Package, Q as Calendar, ag as MessageSquare, a9 as History, au as Camera, a6 as DollarSign, $ as CreditCard, an as Shield, aG as TriangleAlert, aH as Info, aj as Download, aI as QrCode } from "../_libs/lucide-react.mjs";
    ...
    try {
      ...
      const res = await fetch(buildUrl(`/warranty/repairs/${repairId}`), {
        ...
        body: JSON.stringify({
          ...
          expiration_date: expirationDate2.toISOString().split("T")[0],
...
function RepairDetailsPage() {
  ...
  const [repairParts, setRepairParts] = reactExports.useState([]);
  const [loading, setLoading] = reactExports.useState(true);
  ...
  const [showAddPart, setShowAddPart] = reactExports.useState(false);
  const [showAddCustomerNote, setShowAddCustomerNote] = reactExports.useState(false);
  const [newPart, setNewPart] = reactExports.useState({
    part_name: "",
    quantity: 1,
    unit_cost: "",
    notes: ""
  });
  const [customerNote, setCustomerNote] = reactExports.useState("");
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-2 space-y-6", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4 flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-semibold text-white", children: "Customer Notes" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", size: "sm", onClick: () => setShowAddCustomerNote(!showAddCustomerNote), children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(MessageSquare, { className: "mr-2 h-4 w-4" }),
              "Add Note"
            ] })
          ] }),
          showAddCustomerNote && /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
            opacity: 0,
            height: 0
          }, animate: {
            opacity: 1,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Textarea, { placeholder: "Add a customer note (visible to all staff for this customer)...", value: customerNote, onChange: (e) => setCustomerNote(e.target.value), className: "min-h-[80px]" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-end gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", size: "sm", onClick: () => setShowAddCustomerNote(false), children: "Cancel" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", onClick: handleAddCustomerNote, children: "Save Note" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: customerNotes.length > 0 ? customerNotes.map((note, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg bg-blue-50 dark:bg-blue-950/20 p-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-white text-sm", children: note.user || "Unknown" }),
          ...
          ] }, idx)) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-sm text-slate-500", children: "No customer notes yet" }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4 flex items-center justify-between", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4 flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-semibold text-white", children: "Parts Used" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", size: "sm", onClick: () => setShowAddPart(!showAddPart), children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Package, { className: "mr-2 h-4 w-4" }),
              "Add Part"
            ] })
          ] }),
          showAddPart && /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
            opacity: 0,
            height: 0
          }, animate: {
            opacity: 1,
            height: "auto"
          }, className: "mb-4 space-y-3 rounded-lg bg-[#1A1D27] p-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-3 md:grid-cols-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "mb-1 block text-xs font-semibold uppercase tracking-wider text-slate-500", children: "Part Name" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { placeholder: "e.g., iPhone 14 Screen", value: newPart.part_name, onChange: (e) => setNewPart({
                  ...newPart,
                  part_name: e.target.value
                }), className: "border-[#1F2235] bg-[#11131E]" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "mb-1 block text-xs font-semibold uppercase tracking-wider text-slate-500", children: "Quantity" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "number", min: "1", value: newPart.quantity, onChange: (e) => setNewPart({
                  ...newPart,
                  quantity: parseInt(e.target.value) || 1
                }), className: "border-[#1F2235] bg-[#11131E]" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "mb-1 block text-xs font-semibold uppercase tracking-wider text-slate-500", children: "Unit Cost (£)" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "number", step: "0.01", placeholder: "0.00", value: newPart.unit_cost, onChange: (e) => setNewPart({
                  ...newPart,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "mb-1 block text-xs font-semibold uppercase tracking-wider text-slate-500", children: "Notes" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { placeholder: "Optional notes...", value: newPart.notes, onChange: (e) => setNewPart({
                ...newPart,
                notes: e.target.value
              }), className: "border-[#1F2235] bg-[#11131E]" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-end gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", size: "sm", onClick: () => setShowAddPart(false), children: "Cancel" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", onClick: handleAddRepairPart, children: "Add Part" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: repairParts.length > 0 ? repairParts.map((part) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between rounded-lg border border-[#1F2235] p-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-white", children: part.part_name }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: "outline", className: "text-xs", children: [
                  "Qty: ",
                  part.quantity
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-1 text-sm text-slate-600", children: [
                "£",
              ...
              part.notes && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-xs text-slate-500", children: part.notes })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "ghost", size: "sm", onClick: () => handleDeleteRepairPart(part.id), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { className: "h-4 w-4 text-rose-600" }) })
          ] }, part.id)) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-sm text-slate-500", children: "No parts added yet" }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4 flex items-center justify-between", children: [
