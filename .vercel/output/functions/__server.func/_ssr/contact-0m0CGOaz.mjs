...
import { L as Layout, G as GoogleMapsIcon, S as SectionBackdrop, C as Card, B as Button } from "./router-tK0G9_Rh.mjs";
...
function ContactPage() {
  ...
  async function handleContactSubmit(e) {
    ...
    try {
      ...
      const res = await fetch(`${API_BASE_URL}/view/contact`, {
        method: "POST",
        headers: {
